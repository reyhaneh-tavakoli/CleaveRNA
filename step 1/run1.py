...
def run_intarna_for_queries(target_file, query_file, unpaired_prob_file, output_file, sequence):
    ...
    for start_region, end_region, _ in motifs:
        ...
        command = (
            ...
            f"--SeedBP 5 --intLenMax 22 --mode M --MODEL X --acc C --accW 150 "
            f"--accL 100 -e V --temperature 37 --outMode C "
            f"--outCsvCols id1,id2,seq2,E,Etotal,ED1,ED2,Pu1,Pu2,subseqDB,hybridDB,"
        ...
        print(f"Running IntaRNA for target region {target_region}")
