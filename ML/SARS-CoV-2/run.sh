...
python3 importance.py ~/Documents/git/RNAcutter/ML/SARS-CoV-2/mergedData_annotated.num.csv

# Check if the plots folder exists and move it to the HPV directory
if [ -d "plots" ]; then
  mv plots ~/Documents/git/RNAcutter/ML/SARS-CoV-2/
  echo "Plots moved to ~/Documents/git/RNAcutter/ML/SARS-CoV-2"
else
