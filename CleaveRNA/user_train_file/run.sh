...
TARGETS=" target_1.fasta target_2.fasta target_3.fasta"  # Use space-separated file paths
...
python3 "$script_dir" --targets $TARGETS --params $PARAMS --feature_mode default --user_train_file $DEFAULT_TRAIN_FILE --output_dir "$output_dir" 
