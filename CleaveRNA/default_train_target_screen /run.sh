...
feature_script="../Feature.py"  # Correctly reference Feature.py
...
python3 "$script_dir" --targets $TARGETS --params $PARAMS --feature_mode target_screen --default_train_file $DEFAULT_TRAIN_FILE --output_dir "$output_dir"
